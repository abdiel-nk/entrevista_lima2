...
<title>Bienvenido a la entrevista del proceso de admisión Lima 2025 - I</title>
...
<?php
$_Entrevistador=$_POST["Entrevistador"];
...
==================================================================================*/
$sql = "INSERT INTO entrevista20251 (entrevistador, programa, nombres, apellidos, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, Score, filial, fecha)
VALUES ('$_Entrevistador','$_Programa','$_Nombres','$_Apellidos','$_P1','$_P2','$_P3','$_P4','$_P5','$_P6','$_P7','$_P8','$_P9','$_P10','$_P11',
'$_Score', 'Lima', DATE_SUB(NOW(),INTERVAL 0 HOUR))";
...
<head>
    ...
    function updateReloj()
    {
        ...
        if(totalTiempo==0)
        {
            ...
            location.href ="formularioentrevistalima20251.php";
        }else{
